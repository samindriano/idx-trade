...
Latest H-EXC-02 bounded excursion diagnostic: `2026-09-19_ALPHA_HEXC02_BOUNDED_EXCURSION_RESULT_V1.md`
...
- H-EXC-02 bounded excursion diagnostic: a new preregistered absolute-distance balance has `308,067` finite eligible rows, exact score domain `[-1,1]`, mean Top-30 turnover `40.7750%`, q95/max turnover `56.6667% / 86.6667%`, and mean overlap with C1/C2/C4/H-LIQ/H-VOL of `1.3380% / 25.8562% / 4.9431% / 14.7849% / 11.4543%`. Boundedness removes the raw numerical tail, but high churn and unresolved PIT/CA/capacity keep it `FUTURE_RESEARCH / NOVELTY_PENDING / ECONOMIC_CAUTION`; no C5 ID was created. See `2026-09-19_ALPHA_HEXC02_BOUNDED_EXCURSION_RESULT_V1.md`.
