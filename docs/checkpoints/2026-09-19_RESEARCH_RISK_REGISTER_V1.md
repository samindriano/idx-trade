# Research Risk Register V1

| Risk | Severity | Mitigation / current state |
|---|---|---|
| Missing population-wide Data QA authority | P0 | fail closed; no target comparison |
| Financial bundle sparse/partial | P1 | C3 capability audit; no fallback/backfill |
| Corporate-action transition basis unknown | P0 | no realized-return claim |
| Incumbent same-window overlap unavailable | P0 | report `UNKNOWN`, not infer |
| Structural feature dependence | P1 | internal Spearman map, Top-K overlap lab, and horizon/normalization robustness battery; C1/C4 remain duplicate-mechanism caution |
| Turnover/cost burden | P1 | fixed friction diagnostics; not net alpha |
