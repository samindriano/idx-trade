...
| R-15 | H-EXC-02 high churn and residual basis exposure | New absolute-distance balance has exact score domain `[-1,1]`, `308,067` finite eligible rows, mean Top-30 turnover `40.7750%`, and maximum `86.6667%`; the 188-row CA stress leaves `99.9722%` mean and `93.3333%` minimum Top-30 overlap but changes `3,977` ranks. | Numerical stability and high portfolio overlap do not establish capacity, predictive value, or global PIT/CA basis safety. | `OPEN / CAUTION` | Keep as future research only; require novelty, price-basis, capacity, and Data QA admission before any candidate decision. |
