...
| G | New hypothesis discovery | `COMPLETE BOUNDED / ACTIVE QUESTIONS` | H-LIQ-01 retained as `NOVELTY_PENDING / ECONOMIC_CAUTION`; no C5; other directions are source-blocked or non-novel. |
