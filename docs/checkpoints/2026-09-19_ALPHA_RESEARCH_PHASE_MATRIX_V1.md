...
| Q | Independent adversarial review | `PARTIAL / 3 READ-ONLY RED-TEAM REPORTS` | Causal/PIT, economics/fragility, and combination/H-LIQ reviews are complete. Structural checks pass, but PIT/as-of, issuer identity, survivorship, price basis, real capacity, deterministic tie policy, and full independent recomputation remain unresolved; no `READY_FOR_REENTRY`. See `2026-09-19_ALPHA_RESEARCH_LATEST_READIN_V1.md`. |
