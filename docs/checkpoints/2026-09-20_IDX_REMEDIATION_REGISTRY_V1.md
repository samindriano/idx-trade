...
| REM-CA-001 | Projected CA state differs from execution parent | `LINEAGE_CONTRACT_IMPLEMENTED_LOCAL` | `TIMING_MATRIX_IMPLEMENTED_LOCAL / CANONICAL_REPLAY_GATED / REPLAY_GATES_IMPLEMENTED` | Three timing cases, additive CA extension, and restart/idempotency |
...
| REM-CAUSE-001 | Exposure/cash cause state collapses | `CAUSE_V1_IMPLEMENTED_LOCAL` | `TRANSITION_BINDING_IMPLEMENTED_LOCAL / CANONICAL_REPLAY_GATED / REPLAY_ROW_GATES_TESTED` | Cause-to-obligation join, retry transition, and child-consumer replay |
