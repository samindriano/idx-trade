...
| REM-OBL-002 | Partial SELL/replacement lacks quantity lineage | `IMPLEMENTED_LOCAL` | `IMPLEMENTED_LOCAL / CANONICAL_REPLAY_GATED / REPLAY_OPEN` | Paired retry/reversal and cancellation lineage |
