...
| REM-CTRL-001 | Controller phase/attempt held in memory | `RECOVERY_FENCE_IMPLEMENTED_LOCAL` | `IMPLEMENTED_LOCAL / V1_V2_BOUNDARY_MATRIX_CHALLENGE_PASS` | Live child interruption evidence |
