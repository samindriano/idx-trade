...
| REM-ID-001 | Identity normalization/revision splits | `IDENTITY_CONTRACT_IMPLEMENTED_LOCAL` | `TRANSITION_BINDING_IMPLEMENTED_LOCAL / CANONICAL_REPLAY_GATED / HASH_PINNED_CHILD_WIRING_TESTED / AUTHORITY_OPEN` | Alias, same-class revision, hash-pinned child-consumer artifact, and eventual authoritative identity source |
