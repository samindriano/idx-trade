...
| REM-MIG-001 | Legacy migration decision lacks durable provenance | `PROVENANCE_V1_IMPLEMENTED_LOCAL` | `IMPLEMENTED_LOCAL / CONSUMER_OPEN` | Immutable source/hash/classification artifact consumed by migration/recovery entry point |
