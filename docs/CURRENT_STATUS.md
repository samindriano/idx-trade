...
Cumulative evaluated V3 candidate count is `7`. V3-C ordinals 006/007 are viewed historical-development results; provisional V3-D ordinals 008/009 remain unviewed.
...
The authoritative result is recorded in `docs/checkpoints/2026-08-10_RANKING_V3_REGIME_F1_F4_RESULT.md` and `coordination/handoffs/IDX-RANKING-V3-REGIME-RESULT.md`.
...
**No local/full pytest result is claimed for the V3-D implementation.**
