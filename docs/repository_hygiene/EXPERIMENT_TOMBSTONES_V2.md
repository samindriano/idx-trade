...
Disposition: intermediate V1 trajectory/rank-dynamics/persistence branches were deleted under Hygiene V2 after preserving conclusions in docs/PR history.
...
Key development-set deltas versus V2:
...
Disposition: tombstoned; live experiment branch removed.
...
Disposition: prereg/audit/runner/diagnosis intermediates removed. Exact Decision V3 source is not required for E2E. PR history + this tombstone preserve its scientific value.
...
Retained anchor: final V4 result/Decision closure audit only. Intermediate V4 prereg/implementation/runner/audit branches were removed.
...
Disposition: final postmortem preserved as archive evidence; live Stage 3/4/4B/5 chain removed.
...
Disposition: failed/superseded auxiliary model branches were removed unless needed by a current forward sidecar.

## Historical Open / execution-price recovery

Multiple Yahoo/Zapi/TradingView/Investing attempts explored historical Open recovery.
...
Disposition: old source-audit/backfill branches were removed after selected final semantic anchors were archived/retained. E2E should use prospective, explicitly certified execution-price acquisition instead of trying to rescue historical PnL.
...
Disposition: final source-audit result archived; intermediate clutter removed. Do not infer lifecycle from price presence.
...
Disposition: historical PIT-sector heads are archive-only after Hygiene V2 unless a future separately justified acquisition lane is created.
...
Disposition: current clean/continuity/forward-CA anchors are live. Intermediate schedule/event forensic branches were removed after their conclusions were incorporated.
...
Disposition: small semantic/price-path anchor set only; most forensic/admission intermediates removed.
