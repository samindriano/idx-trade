...
6. Verify Official Open remains pinned by commit SHA / deployment variable contract, Stockbit Stream remains default-branch based, and E2E launcher remains pinned to recertified runtime `045e25a19d9f71170d2c863e768102937e59ad73` unless a separately reviewed deployment changes it.
