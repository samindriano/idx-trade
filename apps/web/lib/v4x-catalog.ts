export const V4X_ALPHA = {
  ...
  historicalH5Ic: 0.07493424533009098,
  historicalH10Ic: 0.09185167971133042,
  ...
  historicalFrozenMedianFoldConsensusIc: 0.09775243938276076,
  historicalFrozenControlMedianFoldConsensusIc: 0.08415844149089491,
  historicalFrozenMedianFoldH5Ic: 0.07891122009359626,
  historicalFrozenMedianFoldH10Ic: 0.09095594288451861,

  // Paired incremental evidence. Do not replace this with the old +16.15%
  // difference-of-two-medians headline.
  historicalPairedMeanDailyIncrementalIc: 0.005804318872319132,
  historicalPairedMedianFoldIncrementalIc: 0.0062863346170079215,
  positivePairedConsensusDeltaFolds: 5,
