...
from .ranking_v4_price_path_prepare import prepare_v4b_cache
from .ranking_v4_price_path_run import run_v4b_first_pass


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Ranking V4-B Price-Path tooling")
    sub = parser.add_subparsers(dest="command", required=True)

    prepare = sub.add_parser("prepare", help="prepare frozen pre-outcome V4-B cache")
    ...
    run = sub.add_parser("run", help="run frozen atomic V4-B first pass")
