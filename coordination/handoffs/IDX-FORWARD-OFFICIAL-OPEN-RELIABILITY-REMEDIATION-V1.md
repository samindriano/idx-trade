...
head_commit: `7d6a53f4`  

scope: Official Open transport retry/fallback hardening and idempotent manifest replay verification  
files_changed: `src/idx_trade/official_open_evidence_v1.py`, `src/idx_trade/official_open_capture_runtime_v2.py`, `tests/test_official_open_evidence_v1.py`, `tests/test_e2e_dual_calendar_contract_v1.py`, plus the checkpoint  
...
validation_run: focused Official Open/E2E/Paper suite (87 passed); py_compile; diff-check  
recommended_next_action: independent adversarial review, then selectively integrate into the active E2E lane.
