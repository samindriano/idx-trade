...
Last coordinated update: 2026-08-24 22:47 Asia/Jakarta
...
| 100-session prospective alpha evaluation | `ACTIVE` | `research/idx-forward-evaluation-protocol-v1`; `codex/idx-forward-100-evaluator-v1`; `research/idx-v4-x1-prospective-evaluation-protocol-v1`; merged PR #83 (`bd251c1c`) | V4-X1 protocol, deterministic development-safe evaluator, and the outcome-blind prospective gate implementation are integrated. The protected-outcome access gate/runner remains synthetic-fixture-only until a separate authorization opens the vault; it must verify 100/100 session identity, canonical target maturity/provenance, protocol/evaluator pins, PaperState continuity, benchmark pinning, marker ordering, and one-shot/idempotency. Protected outcomes remain sealed. |
