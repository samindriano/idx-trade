...
| V4 CA residual document continuity replay V1 | `ACTIVE` | `Codex/V4-CA-Residual-Continuity-Replay` | `data/idx-v4-ca-residual-document-continuity-replay-v1` / `ef1beef0f3b91f15772c10b5dbf44756c5399788` | Stage-B-only replay using hash-pinned promoted `event_family_evidence.csv`; no Stage-A rerun, provider, target, model, performance, or protected/fresh-forward outcome work. |
