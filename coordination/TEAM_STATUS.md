...
| Research Integrity / Data QA Gate V1 | `ACTIVE` | PR #103 `audit/research-integrity-data-qa-gate-v1@db97ad38`; stacked PR #108 `data/ca-aware-feature-basis-remediation-v1@9dcded8f` | R3 A-D reconciliation remains controlling: 412 source rows, 389 economic physical events, 153 resolved, 190 unresolved, 46 non-basis excluded. V4 unresolved decomposition is authoritative. Current authorized INC-001/V1.1 scope is limited to official-source acquisition for exactly 21 residual STOCK_SPLIT events plus one separate BBRM REVERSE_SPLIT probe; the stale AADI/ADRO/AALI capability unit is closed with no retry. Rights and all other families remain untouched. Historical negative/as-of/complete-interval authority remains unsupported or unknown; DATA/RESEARCH admission remains blocked. No Phase-E, outcomes, model work, refit/scoring, counter mutation, canonical rewrite, runtime change, or merge is authorized. |
