...
| V4 CA event-window semantics V1 | `REVIEW` | `Codex/V4-CA-Event-Window-Semantics` | `data/idx-v4-ca-event-window-semantics-v1` / HEAD `8224b14070385680588bcb0d987e043a68175cb1` | Validation blocked before Stage 1: 15 focused tests passed, 3 failed in `tests/test_v4_ca_schedule_semantics.py` (`RIGHTS_HMETD`, `STOCK_SPLIT`, `BONUS_SHARES` transition-date expectations). Per handoff, no patch and no Stage 1/2/3 run. No V4 target/model/outcome work or contract changes. |
