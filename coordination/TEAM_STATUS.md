...
| V4 CA event-window semantics V1 | `ACTIVE` | `Codex/V4-CA-Event-Window-Semantics` | `data/idx-v4-ca-event-window-semantics-v1` / HEAD `a281c91a313e8c4ed2ecd823e7f53ccf500ec5b4` | Parser remediation is now present at `beed2e205d4829eb8eac8085c839dce320043a8a`; rerun the frozen local validation gate, then Stage 1/2/3 exactly as handoff-authorized. No V4 target/model/outcome work or contract changes. |
