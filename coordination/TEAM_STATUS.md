...
Last coordinated update: 2026-08-13 02:22 Asia/Jakarta
...
| Broker / Margin source audit V0 | `REVIEW` | `Codex/Broker-Margin-Source-Audit` | `data/broker-margin-source-audit-v0` / bounded 2026-07-14 live audit | Zapi is 100% parity with official IDX Margin and All Stock raw endpoints. Evidence supports an official H2-like category view, not H1 margin-financing flow; strict All Stock metric parity fails (0/220) and PIT timing remains unresolved. Do not derive margin usage/leverage/crowding features. Await ChatGPT review. |
