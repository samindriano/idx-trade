...
| V4-X1 clean Phase-A structural replay | `ACTIVE` | `Codex/V4-X1-Clean-Phase-A-Structural-Replay` | `research/idx-v4-x1-clean-phase-a-structural-replay-v1` / `bca6c9cc8e78608cfa97e3c8a8fe96b115877e50` | One authorized outcome-blind structural replay after exact handoff validation; no refit, numeric target/performance, forward outcomes, or frozen runner/config edits. |
