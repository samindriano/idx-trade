...
| V4 CA blocker attribution V1 | `ACTIVE` | `Codex/V4-CA-Blocker-Attribution` | `data/idx-v4-ca-blocker-attribution-v1` / `07b2a18eb0e717bcf83fd545351c2fdb3b56a0c4` | Offline optimistic-ceiling attribution from the immutable final Stage-B ledger only; no provider, semantic, model, target, or outcome work. |
