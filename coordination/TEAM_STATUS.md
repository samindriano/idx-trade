...
| V4 CA event-window semantics V1 | `REVIEW` | `Codex/V4-CA-Event-Window-Semantics` | `data/idx-v4-ca-event-window-semantics-v1` / HEAD `aa68adb97022903ce69dd4270d96513f5f203310` | Validation blocked before Stage 1: 20 tests passed, 1 failed in `tests/test_v4_ca_input_pin_remediation.py::test_frozen_runners_receive_only_the_exact_pin_replacement`; `scripts/v4_ca_input_pin_remediation.py` raises `V4_CA_PIN_REMEDIATION_BAD_LITERAL_REMAINS`. Per handoff, no patch and no Stage 1/2/3 run. No V4 target/model/outcome work or contract changes. |
