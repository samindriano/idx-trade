...
| V4-X1 clean prospective deployment | `ACTIVE` | `Codex/V4-X1-Clean-Prospective-Deployment` | `integration/v4-x1-clean-prospective-score-v1` / `3e20bc32ecb5ec26860a3a0f4974bd55b223e689` | Deployment-only lane claimed after R2 acceptance. One authorized existing-task updater invocation is permitted at/after 2026-08-20 20:35 Asia/Jakarta, followed by read-only task verification and readiness recheck; no manual pipeline/score/start, counter/registry, provider, model, or outcome access. |
