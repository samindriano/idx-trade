...
|---|---|---|---|---|
| V4-X1 clean Phase-A execution-lock local capture | `ACTIVE` | `Codex/V4-X1-Clean-Phase-A-Execution-Lock` | `research/idx-v4-x1-clean-phase-a-execution-lock-v1` / `3a7f50765341b5c20fef36be4df98a3e7dfa196f` | Execution-only hash capture against pinned Stage-B bundle, Stage-A clean panel, final security master, provenance sidecar, and CA80 prefit manifest. No Phase-A replay, provider, target/rank/return, model, counter, clean-data/CA mutation, V4-X2, or tuning. |
