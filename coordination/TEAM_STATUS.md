...
| Foreign-flow transition alpha challenger | `ACTIVE — shadow ready, partial run binding, admission blocked` | `codex/alpha-challenger-pit-safe-20260919` | 2026-09-17 shadow has 790/963 available rows; EOD/V4 run IDs bind snapshot/OHLCV but not raw Stock Summary SHA/attempt, and security-master as-of remains unattested. One-session structural cross-check: 284/296 common rows, rank rho `0.1197`, top-30 churn `0%`; no performance claim. |
