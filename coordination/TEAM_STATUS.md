...
| PIT-safe V2/V3-B/O2 historical reproduction | `ACTIVE` | `Codex/PIT-Safe-Lineage-Reproduction` | `codex/pit-safe-v2-v3b-o2-reproduction-v1` / claim `0aaeb17` | Preregistered remediation lane: freeze PIT/listing correction protocol before rebuilding any inputs; preserve contaminated lineage and forward/O2 counters; no providers, protected outcomes, tuning, or active-lane overlap. |
