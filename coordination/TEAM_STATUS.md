...
| V4-3 prefit runtime capture | `ACTIVE` | `Codex/V4-3-Prefit-Runtime` | `research/idx-ranking-v4-3-prefit-runtime-v1` / target `640cb257bb93775ec69e3a6f6683fd50cb22417b` | Outcome-blind environment capture only after canonical pin correction: focused tests/compile/diff-check passed; capture the frozen estimator/imputer/package environment. Do not materialize targets/ranks, fit, predict, compute performance, call providers, or access protected/fresh-forward outcomes. |
