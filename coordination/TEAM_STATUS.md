...
| Research Integrity / Data QA Gate V1 | `REVIEW` | `data/ca-aware-feature-basis-remediation-v1@902bb084`; PR #108 | INC-001/V1.1 archive-routing audit completed for exactly SAME/SGER/PACK. Retained KSEI evidence supports `ARCHIVE_KEYS_PUBLICATION_MONTH`; one candidate-month routing false negative was found for SAME, but its exact PDF fetch was not retained and no Ex-date was accepted. SGER/PACK remain archive-row-not-discovered. Economic counts remain 387/159/182/46, rights unresolved 69, proven linkages 27. No remaining RIGHTS acquisition, MMIX retry, other CA family, Phase-E, outcomes, model/refit/scoring, counter mutation, canonical rewrite, production execution, or merge is authorized; awaiting review. |
