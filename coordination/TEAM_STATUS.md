...
| Research Integrity / Data QA Gate V1 | `REVIEW` | PR #103 `audit/research-integrity-data-qa-gate-v1@db97ad38`; stacked PR #108 `data/ca-aware-feature-basis-remediation-v1@aa5ad15f` | Phase-1 fail-closed framework validation/hardening passed. INC-001 remains CONFIRMED/NOT_CLOSED. Outcome-blind CA-aware feature-basis primitives are validated and A-D reconciliation is complete, but historical application remains blocked: exact final-fit support is 629 tickers versus the 610-ticker KSEI census; KSEI lacks per-session as-of/no-event attestation; and structural family coverage/transition taxonomy remains partial or contradictory, including MERGER/VOLUNTARY_CONVERSION. DATA_ADMISSION=FAIL, RESEARCH_ADMISSION=FAIL, MODEL_PROMOTION=NOT_EVALUATED. Phase-E recompute was not run. No V4-X1 refit, outcome access, counter mutation, capture/runtime change, provider acquisition, historical feature recomputation, or science rescue is authorized. |
