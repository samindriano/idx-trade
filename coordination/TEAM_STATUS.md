...
| Research Integrity / Data QA Gate V1 | `ACTIVE` | PR #103 `audit/research-integrity-data-qa-gate-v1@db97ad38`; stacked PR #108 `data/ca-aware-feature-basis-remediation-v1@6cf86704` | Phase-1 fail-closed framework validation/hardening passed. INC-001 remains CONFIRMED/NOT_CLOSED. Outcome-blind CA-aware feature-basis primitives are validated (PR #108 CI 282 passed) but historical application is still NO-GO. Active hardening now resolves exact accepted final-fit population vs frozen KSEI 610-ticker census, temporal/as-of coverage provenance, and structural taxonomy gaps including MERGER/VOLUNTARY_CONVERSION before any global CA coverage can PASS. DATA_ADMISSION=FAIL, RESEARCH_ADMISSION=FAIL, MODEL_PROMOTION=NOT_EVALUATED. No V4-X1 refit, outcome access, counter mutation, capture/runtime change, provider acquisition, historical feature recomputation, or science rescue is authorized. |
