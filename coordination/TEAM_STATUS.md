...
Last coordinated update: 2026-08-26 10:56 Asia/Jakarta
...
| E2E Paper cloud-first orchestration | `REVIEW` | `integration/e2e-cloud-first-orchestration-v1@d2e1a631`; launcher `ops/e2e-paper-cloud-launcher-v1@7f4e7785` | Cross-workflow P1 remediation is implemented: downstream Official Open admission requires scheduled GitHub provenance plus an exact producer capture-code SHA; producer/consumer use the repinnable `IDX_TRADE_OFFICIAL_OPEN_CAPTURE_CODE_REF` repository variable. Focused cloud 36/36, E2E/Official Open 149/149, and full pytest 879/879 pass; PR #92/#93 remain OPEN and unmerged. Live R2/input provisioning and live proof remain pending; no provider/outcome execution is authorized. |
