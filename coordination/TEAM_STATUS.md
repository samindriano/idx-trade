...
Last coordinated update: 2026-08-13 01:16 Asia/Jakarta
...
| Reliability / Uncertainty V0 | `ACTIVE` | `ChatGPT/Reliability-V0` | `research/idx-reliability-uncertainty-v0` / implementation-ready `ded94c5` | Frozen spec `37259c68` and implementation/tests are committed. Awaiting one local execution against pinned external historical O2/V3-B/Open artifacts. Do not alter proxies/gates or fit a reliability model; no fresh-forward access. |
