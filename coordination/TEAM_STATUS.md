...
| Financial PIT Alpha V1 preregistration + support census | `REVIEW` | `Codex/Financial-PIT-Alpha` | `research/idx-financial-pit-alpha-v1` / final `60e16484b83f846742fb18d6ce5fe1e796056acf` / base clean V2 `research/idx-v2-open-alpha-prereg-v1` | `OUTCOME_BLIND_SUPPORT_REMEDIATION_COMPLETE_REVIEW_REQUIRED`: exact `18:00:00 Asia/Jakarta` cutoff, 70,520 support rows / 321 tickers, 966 same-day cases retained, 411 post-18:00 cases excluded, 0 knowledge violations, 6 source conflict keys, and exact 25/52/77 candidate contracts frozen. Inherited support is blocked for Financial challengers: V2F1 has zero Financial support in train and validation; V2F2 has zero Financial-supported training rows and only 388 validation rows. No labels, outcomes, scores, fitting, Financial source/materialization edits, or V3-B/O2 lineage reuse. Full pytest has one unrelated legacy storage expectation failure; focused Financial Alpha tests pass. |
