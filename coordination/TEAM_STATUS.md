...
Last coordinated update: 2026-08-13 01:44 Asia/Jakarta
...
| Reliability / Uncertainty V1 forward shadow | `ACTIVE` | `ChatGPT/Reliability-V1-Spec` | `research/idx-reliability-uncertainty-v1-forward-shadow` / frozen spec `3239a319fbd4ff492b16a74d899a20edc9affa7f` | `RELIABILITY_V1_FORWARD_SHADOW_AUTHORIZED_FROZEN`: deterministic score-margin sidecar only, exact O2 cohort alignment including one outcome-blind 2026-08-12 backfill; no reliability ML, tiers, filtering, outcome access, or independent counter. Implementation handoff is next. |
