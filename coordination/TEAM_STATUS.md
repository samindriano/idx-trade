...
| Financial PIT Alpha V1 preregistration + support census | `ACTIVE` | `Codex/Financial-PIT-Alpha` | `research/idx-financial-pit-alpha-v1` / run from `60e16484b83f846742fb18d6ce5fe1e796056acf` / base clean V2 `research/idx-v2-open-alpha-prereg-v1` | `FINANCIAL_PIT_ALPHA_V1_1800_REMEDIATION_ACCEPTED_FINANCIAL_ERA_ATOMIC_RUN_NEXT`: outcome-blind F4/F5/F6 eligibility and exact atomic historical run authorized. Preserve 18:00 cutoff, 52 slots, 25/77 primary candidates, 52-slot diagnostic only, identical Financial-support row identities, and frozen paired gates. No fresh-forward/O2 outcomes, canonical refit, promotion, or source/materialization changes. |
