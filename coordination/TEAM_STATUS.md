...
| V4 KSEI coverage-gap remediation V1 | `ACTIVE` | `Codex/V4-KSEI-Coverage-Gap` | `data/idx-v4-ksei-coverage-gap-remediation-v1` / `f3a2af51ec925b75498f798f3f1f1bbd72a5f35d` | Exact 43 unresolved KSEI registered-security histories only; strict parser; one targeted provider run plus one continuity replay; no 610 recrawl, alternate source, target, model, or outcome work. |
