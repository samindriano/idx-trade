...
Last coordinated update: 2026-08-30 Asia/Jakarta
...
| Research Integrity / Data QA Gate V1 | `REVIEW` | `data/ca-aware-feature-basis-remediation-v1@3c25cdae`; PR #108 | INC-001/V1.1 retained-evidence decomposition is complete for all 47 `UNRESOLVED_OPERATIONAL_LABEL` events from controlling V14. Every row is KSEI `Voluntary Conversion` with raw SHA-256 match, but no ratio/receiving-security economics; all 47 remain `SEMANTIC_INSUFFICIENT`. V14 remains controlling: 412/387/160/181/46 and 27 proven linkages. Recommendation: `PARK_REMAINING_OPERATIONAL_LABELS`. No provider/source acquisition, other CA-family work, Phase-E, outcomes, model/refit/scoring, counter mutation, canonical rewrite, production execution, or merge is authorized; awaiting review. |
