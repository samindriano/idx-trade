...
Last coordinated update: 2026-08-13 01:05 Asia/Jakarta
...
| Reliability / Uncertainty V0 | `ACTIVE` | `ChatGPT/Reliability-V0` | `research/idx-reliability-uncertainty-v0` / base `357b1b1` | Build a frozen historical O2-OOF diagnostic only: test whether ex-ante uncertainty proxies (support/novelty, imputation burden, score crowding/margin, analogue support) stratify realized O2 ranking quality. No new ML reliability model, no trade filtering/sizing, no fresh-forward outcome access. |
...
- Reliability / Uncertainty V0 is now owned by `research/idx-reliability-uncertainty-v0`; do not create a duplicate reliability lane or a reliability ML model before the V0 diagnostic verdict.
