...
Last coordinated update: 2026-08-13 11:15 Asia/Jakarta
...
| PIT-safe V2/V3-B/O2 historical reproduction | `REVIEW` | `Codex/PIT-Safe-Lineage-Reproduction` | `codex/pit-safe-v2-v3b-o2-reproduction-research-v1` / HEAD `b51fd08` | Corrected PIT-safe panel and V2/V3-B/O2 inputs rebuilt externally; KOCI 2023-10-06 removed generically. Shared V2 feature deltas: 826 rows across 281 tickers and 9 sessions; market context changed in 632 rows. Boundary `HISTORICAL_LADDER_REPLAY_REQUIRED`, executable status `REPRODUCTION_BLOCKED` because available H10 labels end 2025-03-20 while old development artifacts extend to 2026-07-17. No model fit, provider call, protected outcome, or forward counter access. Await ChatGPT independent review. |
