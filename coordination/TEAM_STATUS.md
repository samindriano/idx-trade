...
| GitHub Actions cost optimization | `REVIEW` | `codex/actions-cost-optimization-v1` based on `origin/main@bd166f7fd143fb4c2b48ef6b4f60e549e5c0fde5` | Bounded bootstrap and normal-CI optimization only: production capture schedules, recovery opportunities, provider/runtime semantics, Cloudflare, watchdog, Windows fallback, R2, and scientific contracts are unchanged. Review checkpoint: `docs/checkpoints/2026-08-31_GITHUB_ACTIONS_COST_OPTIMIZATION_V1.md`. No production deployment, dispatch, provider call, token/secret change, or backfill. |
