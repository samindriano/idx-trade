...
| Expected Payoff V0 feasibility | `REVIEW` | `ChatGPT independent review + Codex remediation` | `research/idx-expected-payoff-v0-feasibility` / `ecec6835eaee70f47a8a1c1b43fc2d14a4c34709` | Scientific verdict `EXPECTED_PAYOFF_V0_FEASIBILITY_GO` accepted. Engineering remediation complete: missing frozen-contract tests added, non-gating D1/D10 quantile + monotonicity artifacts persisted, and unrelated storage semantic change reverted. **Do not rerun/retune V0 or fit V1 yet.** |
