...
| Foreign-flow transition alpha challenger | `ACTIVE — preregistered, awaiting unseen evidence` | `codex/alpha-challenger-pit-safe-20260919` | Fixed fast-minus-slow persistence overlay only; historical folds are overlap/consumed and are not used for rescue. Incumbent and prospective runtime remain untouched. |
