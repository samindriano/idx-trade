...
| Historical OPEN corporate-action scale reconstruction | `ACTIVE` | `Codex/Open-CA-Scale-Independent-Verification` | `data/idx-open-ca-scale-reconstruction-v1` / review base `6e69ac37e460668c794d419c3f417738971896bb` | Independently verify the existing 2,184 admitted rows and, only if every frozen official-factor + transformed-HLC rule passes, materialize an immutable Open recovery overlay. Do not acquire new provider/CA data or inspect/recover the 47,292 residual rows. |
