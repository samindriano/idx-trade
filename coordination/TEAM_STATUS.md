...
| Financial PIT Alpha V1 preregistration + support census | `REVIEW` | `Codex/Financial-PIT-Alpha` | `research/idx-financial-pit-alpha-v1` / final `a677cda58c2e963015aecf9bc9b4bb7809bede51` / rerun source `507aaf8bca3286996eb30f3f8e7ea161d8892cc1` / frozen contract external `D:\Documents\Project\idx-financial-pit-alpha-20260815-v1-financial-era-contract` / base clean V2 `research/idx-v2-open-alpha-prereg-v1` | `FINANCIAL_PIT_ALPHA_V1_RERUN_TOOL_TIMEOUT_RESULT_UNDETERMINED_REVIEW_REQUIRED`: exact contract preflight passed; the authorized rerun stopped at tool timeout (exit `124`) after partial F4/F5 artifacts (6 model files), before F6/metrics/manifest/verdict. No valid scientific result or gate was produced. No third run, contract/source/fold/gate changes, or protected-outcome access. Requires explicit new runtime allowance/authorization before continuation. |
