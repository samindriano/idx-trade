...
| V4 CA voluntary-conversion forensic replay V1 | `ACTIVE` | `Codex/V4-CA-VC-Forensic-Replay` | `data/idx-v4-ca-voluntary-conversion-forensic-replay-v1` / `0727d13597315b5c00d7829ff12beac55701b224` | Offline immutable-byte forensic replay only; no provider, model, target, or outcome work. |
