...
| Cloudflare production readiness remediation V2 / Version attestation capability probe V1 | `REVIEW` | PR #122 `codex/cloud-runtime-recovery-integration-v1@37adad4297a19f11a90801df6bd2ac6086d4fb31`; probe candidate `b76fb4aacf43963affde909948782d9220ca5c6a`; checkpoint `docs/checkpoints/2026-09-08_CLOUDFLARE_VERSION_LEVEL_DEPLOYED_BYTE_ATTESTATION_CAPABILITY_PROBE_V1.md` | Dedicated unrouted staging probe proved version-specific beta module readback: both non-deployed candidate versions returned exact `index.js` bytes matching the local frozen SHA-256; the standard Wrangler path preserved tag/message but not `workers/commit_sha`. The strongest defensible contract is direct Version-byte attestation, ready for a narrow V2 integration design. Production remains inert/stub and Windows V1 remains sole automatic controller. No production Worker/version/deployment, secrets/Cron, Windows, GitHub dispatch, provider/R2/PaperState/counter/outcome state, or merge was touched. |
