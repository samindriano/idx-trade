...
| V4 CA blocker attribution V2 | `ACTIVE` | `Codex/V4-CA-Blocker-Attribution-V2` | `data/idx-v4-ca-blocker-attribution-v2` / `620d4efe1165a1e40e4302b5719684664a8cf415` | Offline-only V2 attribution over the exact post-KSEI continuity ledger; validation must pass `13 tests`, compile, and diff-check before one run. No provider/network, CA semantics, schedule acquisition, target/model/performance, or protected/fresh-forward outcome work. |
