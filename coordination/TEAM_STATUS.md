...
| Forward 100-session evaluation protocol | `ACTIVE` | `Codex/Forward-Evaluator-V1` | `codex/idx-forward-100-evaluator-v1` / frozen protocol `6c05499d01ba644c80f0c6bd6d621aac92ab2813` | Implementing the frozen evaluator using synthetic/non-protected fixtures only: exact 100-session/50-50 semantics, deterministic O2/Reliability decisions, marker ordering, malformed-input/provenance fail-closed tests. No protected forward outcome access, actual-forward evaluation, model/counter/protocol change, or O2.1 inclusion. |
