...
| Financial PIT Alpha V1 preregistration + support census | `ACTIVE` | `Codex/Financial-PIT-Alpha` | `research/idx-financial-pit-alpha-v1` / implementation `564139800df72ff1ca7391008f80b004309ae918` / frozen contract external `D:\Documents\Project\idx-financial-pit-alpha-20260815-v1-financial-era-contract` / base clean V2 `research/idx-v2-open-alpha-prereg-v1` | `FINANCIAL_PIT_ALPHA_V1_1800_REMEDIATION_ACCEPTED_FINANCIAL_ERA_ATOMIC_RUN_NEXT`: outcome-blind contract frozen with eligible folds exactly V2F4/V2F5/V2F6; contract SHA `cabeb0db3db44996bda91472576855cb549965d19791f640717502cdd321993c`. CLI wiring correction passed focused tests; full suite retains the unrelated storage expectation failure. One atomic historical run authorized. No fresh-forward/O2 outcomes, canonical refit, promotion, or source/materialization changes. |
