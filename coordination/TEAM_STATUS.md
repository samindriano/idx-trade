...
| Frontend monitoring / capture system | `REVIEW` | `Codex/Frontend Editorial Tech` | `codex/frontend-compare-v2` / `9f17fa1` | Compare table now shows certified absolute V3-B/O1/O2 PR-AUC values plus paired deltas on the 278,168-row / 729-ticker common support; O1 variants remain separate. Other metric families retain a labeled historical V3-B reference. Build and `/compare` HTTP 200 pass. |
