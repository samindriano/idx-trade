...
| Historical CA feature-basis integrity audit | `REVIEW` | `audit/ca-feature-basis-integrity-v1` | Audit complete: backward CA-window risk present; exact v1.2 identity impact material (union 56,602 rows/486 tickers/290 dates); BBCA 2021 excluded before exact fit; strict CA event dates unresolved. Outcome-blind, no provider calls/model/outcome access/remediation. |
