...
| V4 CA event-window semantics V1 | `ACTIVE` | `Codex/V4-CA-Event-Window-Semantics` | `data/idx-v4-ca-event-window-semantics-v1` / HEAD `8224b14070385680588bcb0d987e043a68175cb1` | Bounded local Stage 1 event-window semantics validation; Stage 2 only if the frozen Stage 1 output requires targeted KSEI schedule evidence, followed by the frozen Stage 3 gate. No V4 target/model/outcome work or contract changes. |
