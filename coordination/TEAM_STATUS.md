...
| V4-X session-aligned representation magnitude audit V1 | `ACTIVE` | `Codex/V4-X-Session-Magnitude` | `audit/session-aligned-representation-magnitude-v1` / `41bfd414bb9131280407db7f97d3e74f0547f9a7` | Narrow child audit of practical displacement only: exact parent V4-X H5/H10/UNION support, rank deltas, date-level rank-vector stability, decile churn, and non-rank magnitude relative to current IQR. No new semantics, provider, model/score, target/outcome, parent mutation, primary-liquidity change, feature-definition change, or V4-X2 preregistration. |
