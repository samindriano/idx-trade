...
| V4-X clean-data consolidation V1 | `ACTIVE` | `Codex/V4-X-Clean-Data-Consolidation` | `data/v4-x-clean-data-consolidation-v1` / `256476d6353a6e8c0d0d6f3727560e8d1384869a` | Stage-A parent is preserved; Stage-C PIT Security Identity is now final at `a8c30b2076530c8777b4e7350f4452f51f1f0575` with manifest `5d3bce5ce8776d68a356ea814aa2dcd8909cb26b8d3334ea5e3f68f089a5fe61`. Authorized scope is to materialize/freeze the final clean consolidated input bundle using reconciled historical security-master lineage, including generic FINN + FREN right-only restoration. No refit, reset-counter, provider, score, target, label, protected/fresh-forward outcome, or model work. |
