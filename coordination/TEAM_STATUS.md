...
| Frozen V2/V3-B/O2 training-lineage impact audit | `ACTIVE` | `Codex/Frozen-Lineage-Impact-Audit` | `codex/frozen-lineage-impact-audit-v1` / claim `a22c87c` | Direct artifact verification complete: frozen model/input hashes, row identities, calendar/PIT listing bounds, and O2 common-support invariants are being synthesized against accepted P1 risks. No provider calls, experiments, model/outcome access, retraining, or remediation of active-owner code. |
