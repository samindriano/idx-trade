...
| Investing historical intraday depth audit | `REVIEW` | `Codex/Investing-Intraday-Depth-Audit` | `data/investing-intraday-depth-audit-v1` / review checkpoint pending push | `DEPTH_JUSTIFIES_PREREGISTERED_SECONDARY_INTRADAY_LANE_NOT_BULK_READY`: 3,685/3,685 1-hour probes completed; 2026 available 671/737, 2018 available 326/737, final provider errors 0; 20-ticker fidelity found HLC exact 190/256 and OHLC exact 136/224 comparable rows with CA-like scale anomalies retained fail-closed. Stop for ChatGPT review; no panel/model/backfill work. |
