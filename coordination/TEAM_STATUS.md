...
| V4 CA event-window semantics V1 | `REVIEW` | `Codex/V4-CA-Event-Window-Semantics` | `data/idx-v4-ca-event-window-semantics-v1` / HEAD `a281c91a313e8c4ed2ecd823e7f53ccf500ec5b4` | Validation PASS (`18 passed`, py_compile and diff-check PASS), but Stage 1 blocked before census: runner `ksei_manifest` pin is truncated at 63 characters (`...dba25`) while immutable external `MANIFEST.json` SHA is `7cc3ac4d409c3e15c6aa566b63bedab4268562fd4914d1af198ab29657dba25a`. Per handoff, no patch and no Stage 2/3 run. No V4 target/model/outcome work or contract changes. |
