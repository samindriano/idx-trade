...
| TradingView historical price-path V2.1 remediation | `ACTIVE` | `Codex/TradingView-Historical-Price-Path-V2.1-Remediation` | `data/tradingview-historical-price-path-v2-1-remediation` / prereg checkpoint `0e6c7a4` / current `0e6c7a4`; base `f6716bb861eee396a8b57c42b207af31b4565db7` | Offline remediation is `V2_1_REMEDIATION_READY_FOR_FULL_PREREGISTRATION`; prereg SHA `5fd9b2eefc69fd0c5a29e9d82e790e9f8490583e82e63522f45c815788b5574e`, prereg manifest SHA `795b48bd4c53758ac59308f44658e0ad65733d7da77f743c24c856e1f029400b`, panel SHA unchanged. Exactly five-control anonymous prodata depth preflight is the only next authorized action; no full 978-ticker rerun, model, panel mutation, Path Risk, O2, outcomes, or provider search. |
