...
| Investing historical intraday depth audit | `REVIEW` | `Codex/Investing-Intraday-Depth-Audit` | `data/investing-intraday-depth-audit-v1` / timezone arithmetic remediation complete; push pending | `TIMEZONE_DOCUMENTATION_ONLY_METRICS_UNCHANGED`: UTC 02:00–09:00 converts to 09:00–16:00 WIB; preserved UTC 01:00 boundary rows explain the 08:00 opening label. Conditional listed coverage added; no network, panel, model, or backfill work. Stop for ChatGPT review. |
