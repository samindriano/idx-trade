...
| Alpha available-data research | `ACTIVE` | `codex/alpha-available-data-20260919` | Stage A complete: C1/C2/C4 retained as structural `FUTURE_RESEARCH`, C3 blocked on sparse/partial PIT coverage. Historical alpha claims remain blocked by authoritative Data QA admission; no target/outcome opened. Temporal robustness and independent artifact audit pass structural checks. No incumbent/main/canonical/capture/cloud/R2/scheduler/counter/protected-data mutation; all derived artifacts stay isolated with provenance. |
