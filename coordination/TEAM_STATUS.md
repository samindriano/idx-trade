...
| Historical OPEN corporate-action scale reconstruction | `REVIEW` | `Codex/Open-CA-Scale-Reconstruction` | `data/idx-open-ca-scale-reconstruction-v1` / result `23d3476` | `HISTORICAL_OPEN_CA_SCALE_RECONSTRUCTION_NO_ROWS_ADMITTED`: offline audit of all 49,476 residual Open rows and 32,103 HLC-mismatch rows using existing official IDX factors; 0 exact transformed H/L/C matches and 0 rows recovered, including 1,803 CLEO/SPMA rows. Existing final Open coverage remains 932,464/981,940 = 94.961403%; 266/1,260 dates are below 90%. No new CA acquisition, provider call, panel mutation, model/outcome access, or O2/V4 changes. See `docs/checkpoints/2026-08-17_HISTORICAL_OPEN_CA_SCALE_RECONSTRUCTION_V1.md`. |
