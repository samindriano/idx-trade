...
| Alternative alpha data/source feasibility V1 | `ACTIVE` | `Codex/Alternative-Alpha-Data-Feasibility` | `research/idx-alternative-alpha-data-feasibility-v1` / claimed from `f8628fe544345d5fd6c2fc3ab2adfdde87944aae` | One-shot outcome-blind source census for genuinely new, V4-X1-orthogonal IDX information sets. Covers bounded Zapi/Stockbit, Yahoo `.JK`, official IDX/public APIs, GitHub tooling, disclosure/NLP, macro/cross-asset, and realistic alternative-data candidates. No model/feature fit, target/performance/protected-forward access, V4-X1/O2/counter mutation, bulk backfill, or duplicate intraday capture. |
