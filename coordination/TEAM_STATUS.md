...
| V4-3 prefit runtime capture | `ACTIVE` | `Codex/V4-3-Prefit-Runtime` | `research/idx-ranking-v4-3-prefit-runtime-v1` / target `c540981255972cac10b11cfc48b9e8550418add1` | Outcome-blind environment capture only after protocol-pin remediation: run focused tests, compile/check, and capture the frozen estimator/imputer/package environment. Do not materialize targets/ranks, fit, predict, compute performance, call providers, or access protected/fresh-forward outcomes. |
