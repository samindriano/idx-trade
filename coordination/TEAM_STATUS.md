...
| V4 CA event-window semantics V1 | `ACTIVE` | `Codex/V4-CA-Event-Window-Semantics` | `data/idx-v4-ca-event-window-semantics-v1` / HEAD `8affe6d6024109b438f4d9d4b55e43759c4f8b71` | Continuation authorized from immutable Stage 1 result. Run Stage 2 only with fresh `...schedule-evidence-20260818-v3`, then Stage 3 with fresh `...event-window-final-20260818-v3`; no Stage 1 rerun, source/config patch, semantics/provider/threshold changes, or V4 target/model/outcome work. |
