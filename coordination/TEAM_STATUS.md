...
| V4 CA schedule event impact attribution V1 | `ACTIVE` | `Codex/V4-CA-Schedule-Event-Impact` | `data/idx-v4-ca-schedule-event-impact-attribution-v1` / `a38791863cee7e17365942e6dc202e26692a593f` | Offline exact 39-event impact/subset attribution only. Validation must pass `13 tests`, compile, and diff-check before one run over the immutable post-KSEI ledger. No provider/schedule acquisition, KSEI retry, semantic change, target/model/performance, or protected/fresh-forward outcome work. |
