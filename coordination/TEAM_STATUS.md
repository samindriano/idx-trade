...
| Foreign-flow transition alpha challenger | `ACTIVE — shadow diagnostic ready, admission blocked` | `codex/alpha-challenger-pit-safe-20260919` | Fixed fast-minus-slow persistence overlay materialized on 2026-09-17 with 790/963 available rows, but capture-attempt and security-master as-of attestations are missing. Historical folds remain excluded; incumbent/runtime untouched. |
