...
| Research Integrity / Data QA Gate V1 | `REVIEW` | PR #103 `audit/research-integrity-data-qa-gate-v1@db97ad38`; stacked PR #108 `data/ca-aware-feature-basis-remediation-v1@3ba8b286` | R3 A-D reconciliation complete. External manifest `D:\Documents\Project\idx-ca-aware-feature-basis-remediation-20260827-v3-final\MANIFEST.json` SHA-256 `198b619e7e465597de935837346a6369b0395162bc140fef1eb7ae5f8d0f690e`; fresh deterministic rerun has zero output-hash mismatches. Exact final-fit support is 629 tickers versus the 610-ticker KSEI census; KSEI lacks per-session as-of/no-event attestation; and structural family coverage/transition taxonomy remains partial or contradictory, including MERGER/VOLUNTARY_CONVERSION. Phase-E historical recompute remains blocked. No V4-X1 refit, outcome access, counter mutation, capture/runtime change, provider acquisition, historical feature recomputation, or science rescue is authorized. |
