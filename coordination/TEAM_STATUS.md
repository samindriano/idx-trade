...
| V4 Corporate-Action Price-Basis Continuity Gate V1 | `ACTIVE` | `Codex/V4-CA-Continuity` | `data/idx-v4-corporate-action-continuity-gate-v1` / parent `b536c832730bd0c5e2dd6952b44cf9b11b4573f9` | Outcome-blind downstream gate audit for the exact V4 739 decision tickers / frozen 600 validation sessions. Reuse official IDX/KSEI CA artifacts first; event-family-specific dates/identities must be explicit, unresolved evidence fails closed. No target/rank materialization, model/performance/outcome access, or V4 contract changes. |
