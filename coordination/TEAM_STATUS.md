...
Last coordinated update: 2026-08-12 19:43 Asia/Jakarta
...
| O2.1 flat-range challenger experiment | `ACTIVE` | `Codex/O2.1-flat-range + ChatGPT spec/review` | `research/idx-ranking-ohlcv-o2-1-flat-range-v1` | User explicitly authorized a separate historical O2.1 experiment on 2026-08-12. Freeze/test an explicit flat-range encoding on expanded historical support. **Do not modify O2 model, its 1/100 forward counter, or any forward outcomes.** |
...
- O2.1 research is authorized only on its dedicated challenger branch. It must remain historically isolated and must not alter, reset, reinterpret, or consume outcomes from the active O2 fresh-forward 1/100 gate.
