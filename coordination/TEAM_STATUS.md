...
- Expected Payoff V0 is closed with accepted `FEASIBILITY_GO`. Expected Payoff V1 is closed for this run with `EXPECTED_PAYOFF_V1_NO_SURVIVOR` at `42b1ae21...`; no payoff candidate search, post-result rescue, or fresh-forward outcome access.
