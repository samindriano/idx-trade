...
| Market/index prospective EOD archive extension | `ACTIVE` | `Codex/Forward-EOD-Automation-UI` | `integration/forward-eod-automation-monitoring` / `6b85a93` | Consolidating legacy Open archive scheduling into the canonical Forward EOD runner at 18:00 with logon catch-up, official-calendar/date validation, and no duplicate capture system. Controlled capture remains gated until after cutoff. |
