...
Last coordinated update: 2026-08-13 02:03 Asia/Jakarta
...
| Reliability / Uncertainty V1 forward shadow | `REVIEW` | `ChatGPT/Reliability-V1-Spec + Codex` | `research/idx-reliability-uncertainty-v1-forward-shadow` / implementation `ed28bd6` / docs `4ba5676` / frozen spec `3239a319fbd4ff492b16a74d899a20edc9affa7f` | `RELIABILITY_V1_FORWARD_SHADOW_IMPLEMENTED_REVIEW_REQUIRED`: deterministic score-margin sidecar is implemented and one outcome-blind 2026-08-12 alignment is complete. Sidecar `836/836` rows, `806 AVAILABLE`, `30 NOT_APPLICABLE_O2_UNSCORED`; parquet SHA `76e5b798...be4422e`, manifest SHA `910cfc49...20dbb`. No reliability ML, tiers, filtering, outcome access, or independent counter. Awaiting ChatGPT review. |
