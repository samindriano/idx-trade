...
| V4 target-support census remediation | `ACTIVE` | `Codex/V4-Target-Support-Census-Remediation` | `research/idx-v4-target-support-census-remediation-v1` / `2e46937f4b5a8b8338d3dfe2d088705c49860b0a` | Bounded outcome-blind rerun using the approved derivative Open root plus verified CA overlay. Focused guard must preserve parent `AMBIGUOUS` tradability-anchor semantics before one fresh census. No provider calls, labels/outcomes, model fit, or V4 contract changes. |
