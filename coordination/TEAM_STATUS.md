...
| E2E Paper cloud-first orchestration | `ACTIVE` | `integration/e2e-cloud-first-orchestration-v1@299bfb49`; launcher `ops/e2e-paper-cloud-launcher-v1@6da99ed8` | Cross-workflow P1 remediation: bind downstream Official Open admission to an explicit accepted producer capture-code SHA while retaining scheduled-event, timing, capture-only, and no-retroactive guards; PR #92/#93 remain unmerged. No live/provider/outcome execution is authorized. |
