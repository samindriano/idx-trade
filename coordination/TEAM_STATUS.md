...
| V4 KSEI CA-history census V1 | `ACTIVE` | `Codex/V4-KSEI-CA-History-Census` | `data/idx-v4-ksei-ca-history-census-v1` / prepared `15876e9cbaad904364ddb13d0fc3dbeb5f8db0ed` | Exact local KSEI history census authorized by handoff: validation must pass before one provider run over the frozen 610-ticker input, followed by offline continuity gate V2. No R5/R10, targets/ranks, model, prediction, performance, outcomes, provider substitution, or policy tuning. |
