...
| Frontend monitoring / capture system | `ACTIVE` | `Codex/Frontend Editorial Tech` — owner keeps this row current | `frontend/editorial-tech-v1` / `4580e49` | Rebuild the historical compare view on the latest editorial architecture: fixed V3-B baseline plus at most two challengers; display absolute score and delta; do not alter research/runtime semantics. |
