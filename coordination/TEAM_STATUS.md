...
| V4 CA event-window semantics V1 | `ACTIVE` | `Codex/V4-CA-Event-Window-Semantics` | `data/idx-v4-ca-event-window-semantics-v1` / HEAD `8affe6d6024109b438f4d9d4b55e43759c4f8b71` | Input-pin assertion remediation is present; rerun the frozen validation gate and corrected Stage 1, then Stage 2/3 only if authorized by the frozen verdict. No V4 target/model/outcome work or contract changes. |
