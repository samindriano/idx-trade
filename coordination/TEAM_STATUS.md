...
| V4-X1 clean prospective readiness | `REVIEW` | `Codex/V4-X1-Clean-Prospective-Readiness` | `integration/v4-x1-clean-prospective-score-v1` / `4bd588f7e7d862dd148328efc3aba544f8b47433` | R2 complete: 13/13 blobs, focused pytest, py_compile, diff-check PASS; existing `IDXTrade-ForwardEOD` inspected read-only and canonical runtime resolved. Readiness `V4_X1_CLEAN_FORWARD_READYNESS_WAITING_FIRST_POST_FREEZE_SESSION`; clean counter `0/100`, no candidate, no missing canonical history. Readiness manifest hashes: panel `25eb0d0c...4784c2e`, security master `51fecc3b...c3cf0e`, model manifest `30e1b505...40f79cf`. No scheduler/pipeline/score/counter/provider/model/outcome mutation. |
...
| V4-X clean-data consolidation V1 | `REVIEW` | `Codex/V4-X-Clean-Data-Consolidation` | `data/v4-x-clean-data-consolidation-v1` / `d134d48db635bbbae712b4d40c2b08f6f3630cee` | Stage-B final clean identity bundle materialized and hash-verified under external manifest `561b1d72168debae319829faa549cb9b6fab662d989c5e7ab8b6b64f9bd01358`: final security master `979/979`, accepted FINN + FREN overlay `2/2`, Stage-A panel bytes unchanged. Stage-C manifest `5d3bce5ce8776d68a356ea814aa2dcd8909cb26b8d3334ea5e3f68f089a5fe61` and decision `V4_X_EXACT_TRAINING_REPRESENTATION_AFFECTED_BY_SECURITY_IDENTITY_OMISSION` preserved. Focused `15 passed`, py_compile/diff-check PASS; full pytest has one unrelated pre-existing storage assertion failure. No refit, reset-counter, provider, score, target, label, protected/fresh-forward outcome, or model work. Independent review required before deterministic replay/refit. |
