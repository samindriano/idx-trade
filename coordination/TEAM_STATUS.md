...
| V4 CA residual document semantics V1 | `ACTIVE` | `Codex/V4-CA-Residual-Document-Semantics` | `data/idx-v4-ca-residual-document-semantics-v1` / `3e99d4a596e3878a6df24d920ed54badd6c3d310` | Offline reuse of the existing Stage-2 KSEI raw corpus only; no provider, target, model, performance, or protected/fresh-forward outcome work. |
