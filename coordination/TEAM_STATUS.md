...
| V4 CA blocker attribution V1 | `ACTIVE` | `Codex/V4-CA-Blocker-Attribution` | `data/idx-v4-ca-blocker-attribution-v1` / `fd5e143669eb875a9887c71c74e13ce5a404b781` | One authorized retry after preflight-only correction; expected scope is exact validation, immutable Stage-B ledger SHA verification, and one offline attribution run only. No patch/provider/semantic/model/target/outcome work. |
