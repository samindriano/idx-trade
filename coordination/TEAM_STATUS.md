...
| E2E Paper cloud-first orchestration | `REVIEW` | `integration/e2e-cloud-first-orchestration-v1@9ebb595b`; launcher `ops/e2e-paper-cloud-launcher-v1@e1733f55` | Cloud durability adapter and pinned default-branch launcher are prepared with synthetic tests. Private input-bundle provisioning, live R2/provider verification, and one future live session remain pending. Windows/manual retirement is not authorized until those gates pass. |
