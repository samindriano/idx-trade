...
| V4-3 prefit runtime capture | `ACTIVE` | `Codex/V4-3-Prefit-Runtime` | `research/idx-ranking-v4-3-prefit-runtime-v1` / target `2c50e4a24e42593360f5ef6e87b28abe4768b5db` | Outcome-blind environment capture only: run focused tests, compile/check, and capture the frozen estimator/imputer/package environment. Do not materialize targets/ranks, fit, predict, compute performance, call providers, or access protected/fresh-forward outcomes. |
