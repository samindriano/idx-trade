...
| V4-X clean-data consolidation V1 | `ACTIVE` | `ChatGPT/V4-X-Clean-Data-Consolidation` | `data/v4-x-clean-data-consolidation-v1` / `04b295a9443c2926782d4cebff532ee6e81238c3` | Execution-only Stage-A HLC/Open/provenance consolidation. Final universe waits for the separately owned PIT Security Identity / Listing-Domain adjudication. No provider, model/score, target/outcome, forward-counter, V4-X refit, V4-X2, session-window, primary-liquidity, FREN/KOCI/universe repair, parent overwrite, or output-pin loosening. |
