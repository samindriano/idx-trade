...
| V4-X session-aligned counterfactual sensitivity audit V1 | `ACTIVE` | `Codex/V4-X-Session-Sensitivity` | `audit/session-aligned-counterfactual-sensitivity-v1` / `a30093032a12d605db66a166d2f55bfb679e84f0` | Outcome-blind, provider-free sensitivity audit after the exact PIT listing filter: observed-row versus strict official-session counterfactual on frozen V4-X H5/H10/UNION support. No parent artifact mutation, repair, model/refit/score, target, protected/fresh-forward outcome, or frozen V4-X definition change. |
...
| PIT Security Identity / Listing-Domain V1 adversarial audit | `ACTIVE` | `Codex/PIT-Security-Identity-Audit` | `audit/pit-security-identity-v1` / `a56265e452541e4d205376bbe8194f4887a920b4` | Outcome-blind, provider-free audit of generic authoritative historical identity restoration against frozen V4-X representation. Stage A preregistration must precede Stage B counterfactual; Stage C support intersection is allowed only if representation changes. No parent artifact mutation, model fit/score, targets, protected/fresh-forward outcomes, or forward-counter changes. |
