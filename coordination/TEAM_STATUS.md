...
Last coordinated update: 2026-08-13 14:52 Asia/Jakarta
...
| Clean V2 Open-alpha research pass (V2.1/V2.2) | `REVIEW` | `ChatGPT/Open-Alpha-Research` | `research/idx-v2-open-alpha-research-pass-v1` / `504c51b` | Outcome-blind design pass complete. Recommend exactly two challengers on clean-V2 Open common support: V2.1 = exact O2 same-day Open geometry; V2.2 = previous-PIT-valid-ACTIVE-range Open displacement. O1 overnight/intraday decomposition is excluded because already outcome-tested. No model fit/outcome access; next boundary is clean-replay final acceptance then preregistered cache/audit contract. |
