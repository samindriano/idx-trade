...
| V4-3 target/execution freeze | `ACTIVE` | `Codex/V4-3-Target-Execution-Freeze` | `research/idx-ranking-v4-3-target-execution-freeze-v1` / target `7f6b90e0ed09347c5f0fa638b6c3ba3e73273d59` | Outcome-blind local validation only: run frozen synthetic tests, PIT support refresh, and execution-code manifest capture if the exact 6x100 identity is preserved. Do not materialize R5/R10, target ranks, fit, predict, compute performance, call providers, acquire Corporate Actions, or access protected/fresh-forward outcomes. |
