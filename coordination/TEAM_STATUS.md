...
| E2E Paper cloud-first orchestration | `ACTIVE` | `integration/e2e-cloud-first-orchestration-v1@d2e1a631`; launcher `ops/e2e-paper-cloud-launcher-v1@7f4e7785` | P2 auditability remediation: persist the already-validated Official Open cloud admission provenance in the immutable PREOPEN stage result/commit and verify it through replay; no science, live execution, provider, outcome, scheduler, or merge changes. |
