...
| Frontend monitoring / capture system | `REVIEW` | `Codex/Forward-EOD-Automation-UI` | `integration/forward-eod-automation-monitoring` / `6b85a93` | Model-evidence selector now renders the existing O1 and O2 groups; default O2 preserved. UI-only patch pushed; Next.js production build passed. |
