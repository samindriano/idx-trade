...
| V4-3 primary-liquid support census | `ACTIVE` | `Codex/V4-3-Primary-Liquid-Support` | `research/idx-ranking-v4-3-preregistration-v1` / `8dbde070b18edf432348062e5a9218f6ef2665f9` | Exact outcome-blind primary-liquid support run only. Config is frozen and must not be changed. Run focused preregistration tests, then support census with accepted Open derivative + CA overlay; no target materialization, labels/outcomes, model fit, predictions, performance, provider calls, or V4 contract changes. |
